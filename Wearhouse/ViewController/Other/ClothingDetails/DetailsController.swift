...
final class DetailsController: UIViewController {
    ...
    lazy var itemImageView: UIImageView = {
        ...
        iv.sd_setImage(with: URL(string: item.imageID, relativeTo: APIHandler.clothingImagesURL), placeholderImage: UIImage(named: "placeholder.upload"))
        return iv
    }()
...
extension DetailsController: UIPickerViewDelegate, UIPickerViewDataSource {
...
extension DetailsController: SeasonsPickerViewDelegate, TagsPickerViewDelegate {
...
extension DetailsController: UIColorPickerViewControllerDelegate {
    func colorPickerViewController(_ viewController: UIColorPickerViewController, didSelect color: UIColor, continuously: Bool) {
        item.color = color
    }
}

extension DetailsController: UIAdaptivePresentationControllerDelegate {
...
extension DetailsController: PHPickerViewControllerDelegate, CropViewControllerDelegate {
