...
public class MyProfileController: UIViewController {
    ...
    private func getMyProfile() async -> PrivateUser? {
        ...
        do {
            userProfile = try await APIClient.shared.userHandler.getMyUserProfile()
    ...
    private func retrieveProfilePicture() async -> URL? {
        do {
            return try await APIClient.shared.userHandler.getMyProfilePicture()
            ...
            do {
                ...
                return URL(string: userProfile.profile_picture, relativeTo: APIClient.baseURL)
            } catch {
                return nil
            }
        } catch {
